- Все еще при сохранении иногда не обновляется статус на желтый

- Сделать так, чтобы Ctrl+C Ctrl+V работало. Сейчас только правой кнопкой окпирование работает
