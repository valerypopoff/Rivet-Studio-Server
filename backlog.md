- in managed mode, any published project save makes it "unpublished changes" even when no actual change in the project was made. That's bad

- Проверить, что установка библиотек работает в кубернетисе когда много реплик

- Убедиться, что выполнение воркфлоу по ендпоинтам не тормозит из-за s3 и все что надо кешируется и все такое. Сейчас кажется долговато - 500мс против 100мс в режиме файлсистем
