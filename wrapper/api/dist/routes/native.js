...
nativeRouter.post('/readdir', async (req, res) => {
    try {
...
nativeRouter.post('/read-text', async (req, res) => {
    try {
...
nativeRouter.post('/read-binary', async (req, res) => {
    try {
        const { path: filePath, baseDir } = req.body;
        const resolvedPath = resolveBaseDir(filePath, baseDir);
        const safePath = validatePath(resolvedPath);
...
nativeRouter.post('/write-text', async (req, res) => {
    try {
...
nativeRouter.post('/write-binary', async (req, res) => {
    try {
        const { path: filePath, contents, baseDir } = req.body;
        const resolvedPath = resolveBaseDir(filePath, baseDir);
        const safePath = validatePath(resolvedPath);
...
nativeRouter.post('/exists', async (req, res) => {
    try {
        const { path: filePath, baseDir } = req.body;
        const resolvedPath = resolveBaseDir(filePath, baseDir);
        const safePath = validatePath(resolvedPath);
...
nativeRouter.post('/mkdir', async (req, res) => {
    try {
...
nativeRouter.post('/remove-dir', async (req, res) => {
    try {
        const { path: dirPath, recursive = false } = req.body;
        const safePath = validatePath(dirPath);
...
nativeRouter.post('/remove-file', async (req, res) => {
    try {
        const { path: filePath, baseDir } = req.body;
        const resolvedPath = resolveBaseDir(filePath, baseDir);
        const safePath = validatePath(resolvedPath);
