...
export async function listWorkflowProjects(root) {
    const entries = await fs.readdir(root, { withFileTypes: true });
    return Promise.all(entries
...
export async function getWorkflowFolder(root, folderPath) {
...
export async function getWorkflowProject(root, filePath) {
...
export async function moveWorkflowFolder(root, sourceRelativePath, destinationFolderRelativePath) {
