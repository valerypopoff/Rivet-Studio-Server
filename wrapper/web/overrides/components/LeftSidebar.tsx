...
import { ProjectInfoSidebarTab } from '../../../../rivet/packages/app/src/components/ProjectInfoSidebarTab';
import { GraphInfoSidebarTab } from '../../../../rivet/packages/app/src/components/GraphInfoSidebarTab';
  ...
  return (
    ...
    >
      <div className="toggle-tab" onClick={() => setSidebarOpen(!sidebarOpen)}>
        {sidebarOpen ? <CollapseLeftIcon /> : <ExpandRightIcon />}
      </div>
      <div className="tabs">
